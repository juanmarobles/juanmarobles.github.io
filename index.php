...
<body style="height: 100%; background-color: rgba(0,0,0)">
  ...
  <header>
    <video autoplay loop id="bg-video">
      <source style="width: 100%;" src="bg.mp4" type="video/mp4" />
  ...
  <section class="">
    ...
    <h2><span class="home_titulo-secundario">Java Developer</span></h2>
  </section>
  ...
  <div class="hero dark-bg-2">
    <div class="hero-content">
      <div class="left">
        <p>Soy Juan Manuel Robles, Tengo 24 años. Actualmente soy desarrollador de Java con Spring y Spring Boot, con conocimientos en base de datos como MySQL, PostgreSQL.
          También con experiencia en PHP con Laravel.
          En la actualidad estoy implementando conocimientos en Frontend con React.js
          Lo que más me gusta de la programación Backend, es dar soluciones a problemas que aparentemente son complicados.
        </p>
        <div class="">
        <a href="" class="btn btnn"><img src="cv.png" width="100px" style="background-color: white; border-radius: 10px;" alt=""></a>
      </div>
    </div>
      <div class="right">
        <img class="img-style" style="border-radius: 10px;" src="sobremi-img.png" width="400px">
      </div>
    </div>
  </div>
  <hr>
  ...
  <main class="dark-bg">
    ...
    <section id="skillset" class="dark-bg">
      ...
      <div>
        ...
        <div>
          <img src="java.png"> <span class="tooltip">JAVA</span>
        </div>
        <div>
          <img src="javaspring.png"> <span class="tooltip">Spring</span>
        </div>
        <div>
    ...
    <div id="contactos" class="d-flex justify-content-center ">
      <div class="">
        <div class="row">
          <div class="left2 d-flex align-items-start">
            ...
            <div id="contactos" class="d-flex justify-content-end ">
              <form class="contact-form" method="POST" action="enviar_consulta.php">
                ...
                <button class="btn btn-success" style="width:50%;">Enviar</button>
            </div>
          </div>
          </form>
      ...
      <div class="">
        ...
        <div class="d-flex justify-content-center full-width social-links">
          <div class="justify-content-between">
            ...
            <a target="_blank" href="https://www.linkedin.com/in/juanmarobles/"> <img class="social" src="linkedin.png" style="width: 40px;" alt=""></a>
          </div>
        </div>
        <div class="made-with">
          <div class="row">
